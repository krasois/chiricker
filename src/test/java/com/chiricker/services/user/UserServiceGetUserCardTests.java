...
@SpringBootTest
@ActiveProfiles("test")
public class UserServiceGetUserCardTests {
    ...
    public void testGetSettings_WithValidHandle_ShouldNotReturnNullOrThrow() throws UserNotFoundException {
        UserCardViewModel result = this.userService.getUserCard(this.user.getHandle());
    ...
    public void testGetSettings_WithValidHandle_ShouldMapCorrectly() throws UserNotFoundException {
        UserCardViewModel model = this.userService.getUserCard(this.user.getHandle());
